...
const { ensureClosed } = require('./ui_controls');
const { activateSkills, increaseSkills } = require('./master_actions');
const { twoPagesOfHeroes } = require('./hero_actions');
const {
    tapAccept,
    tapSkip,
    tapSave,
...
let macro = new Macro('New Character - Start');
...
macro = new Macro('New Character - Loop');
