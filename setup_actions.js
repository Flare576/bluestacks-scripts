...
const {
    ...
    prestigeConfirm,
    smallDiscover,
} = require('./setup_locations');
const { setMaxBuy, pagePartialUp } = require('./ui_controls');
const { tapNineButtons } = require('./hero_actions');
const { HIT_DURATION, UI_DURATION, WIN_DURATION } = require('./durations');
